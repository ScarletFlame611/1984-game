...
class In_game_menu:
    def __init__(self, bg_image_name, hero_image_name, map_image_name):
        ...
        self.scroll = global_peremen.Scroll([('', self.open_mup, map_image_name, (global_peremen.WIDTH // 5, global_peremen.HIGH // 5)), ('', self.open_mup, map_image_name, (global_peremen.WIDTH // 5, global_peremen.HIGH // 5)), ('', self.open_mup, map_image_name, (global_peremen.WIDTH // 5, global_peremen.HIGH // 5)), ('', self.open_mup, map_image_name, (global_peremen.WIDTH // 5, global_peremen.HIGH // 5)), ('click me pls', self.open_mup,)], 20, 100)
        self.mod = 'menu'
